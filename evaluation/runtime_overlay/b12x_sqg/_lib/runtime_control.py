...
class KernelResolutionFrozenError(RuntimeError):
    """Raised when b12x_sqg is asked to resolve a new kernel after freeze."""
...
def raise_if_kernel_resolution_frozen(
    ...
    *,
    ...
    details = [f"b12x_sqg kernel resolution is frozen; refusing {kind}"]
    ...
    details.append(
        "warm up this kernel shape before calling b12x_sqg.freeze_kernel_resolution()"
    )
