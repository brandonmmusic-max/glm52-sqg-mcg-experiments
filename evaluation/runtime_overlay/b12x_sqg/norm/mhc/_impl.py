...
def _b12x_mhc_pre_impl(
    ...
    *,
    ...
    if (
        ...
        from b12x_sqg.norm.mhc._kernels import (
...
def _b12x_mhc_post_impl(
    ...
    *,
    ...
    if _supports_mhc_post_hidden(hidden_size):
        from b12x_sqg.norm.mhc._kernels import run_mhc_post
...
@torch.library.custom_op(
    "b12x_sqg::mhc_pre_planned_functional",
    mutates_args=(),
)
...
@torch.library.custom_op(
    "b12x_sqg::mhc_post_pre_planned_functional",
    mutates_args=(),
)
...
@torch.library.custom_op(
    "b12x_sqg::mhc_post_planned_functional",
    mutates_args=(),
)
...
def b12x_mhc_pre(
    ...
    *,
    ...
    if compiling and no_caller_owned_buffers:
        ...
        return torch.ops.b12x_sqg.mhc_pre_planned_functional(
            residual,
            fn,
            hc_scale,
            hc_base,
...
def b12x_mhc_post_pre(
    ...
    *,
    ...
    if compiling and no_caller_owned_buffers:
        ...
        norm_weight_for_kernel = norm_weight if norm_weight is not None else residual
        return torch.ops.b12x_sqg.mhc_post_pre_planned_functional(
            x,
            residual,
            prev_post,
            prev_comb,
...
def b12x_mhc_post(
    ...
    *,
    ...
    if compiling and out is None:
        return torch.ops.b12x_sqg.mhc_post_planned_functional(
            x,
            residual,
            prev_post,
            prev_comb,
