...
from b12x_sqg._lib.utils import current_cuda_stream
...
@torch.library.custom_op(
    "b12x_sqg::mhc_post_pre_partial_launch",
...
def run_mhc_post_pre_partial(
    *,
    ...
    torch.ops.b12x_sqg.mhc_post_pre_partial_launch(
        x,
        residual,
        prev_post,
        prev_comb,
...
@torch.library.custom_op(
    "b12x_sqg::mhc_post_pre_prefill_partial_launch",
    mutates_args=("partials", "out"),
)
...
def run_mhc_post_pre_prefill_partial(
    *,
    ...
    torch.ops.b12x_sqg.mhc_post_pre_prefill_partial_launch(
        x,
        residual,
        prev_post,
        prev_comb,
...
@torch.library.custom_op(
    "b12x_sqg::mhc_post_pre_prefill_block_m_partial_launch",
    mutates_args=("partials", "out"),
)
...
def run_mhc_post_pre_prefill_block_m_partial(
    *,
    ...
    torch.ops.b12x_sqg.mhc_post_pre_prefill_block_m_partial_launch(
        x,
        residual,
        prev_post,
        prev_comb,
...
@torch.library.custom_op(
    "b12x_sqg::mhc_post_pre_prefill_gram_launch",
    mutates_args=("partials", "out"),
)
...
def run_mhc_post_pre_prefill_gram(
    *,
    ...
    torch.ops.b12x_sqg.mhc_post_pre_prefill_gram_launch(
        x,
        residual,
        prev_post,
        prev_comb,
...
@torch.library.custom_op(
    "b12x_sqg::mhc_prefill_bf16_project_launch",
...
def run_mhc_prefill_bf16_project(
    *,
    ...
    torch.ops.b12x_sqg.mhc_prefill_bf16_project_launch(
        out,
        fn_bf16,
        partials,
    )
...
@torch.library.custom_op(
    "b12x_sqg::mhc_prefill_tf32_project_launch",
    mutates_args=("partials",),
)
...
def run_mhc_prefill_tf32_project(
    *,
    ...
    torch.ops.b12x_sqg.mhc_prefill_tf32_project_launch(
        out,
        fn,
        partials,
    )
...
@torch.library.custom_op(
    "b12x_sqg::mhc_post_pre_partial_alloc",
    mutates_args=(),
)
...
def run_mhc_post_pre_partial_alloc(
    *,
    ...
    return torch.ops.b12x_sqg.mhc_post_pre_partial_alloc(
...
def run_mhc_post(
    *,
    ...
    torch.ops.b12x_sqg.mhc_post_launch(
        x,
        residual,
        prev_post,
        prev_comb,
...
@torch.library.custom_op(
    "b12x_sqg::mhc_pre_partial_launch",
    mutates_args=("partials", "out"),
)
...
def run_mhc_pre_partial(
    *,
    ...
    torch.ops.b12x_sqg.mhc_pre_partial_launch(
        residual,
        fn,
        partials,
        out,
...
@torch.library.custom_op(
    "b12x_sqg::mhc_finalize_gram_launch",
...
def run_mhc_finalize_gram(
    *,
    ...
    torch.ops.b12x_sqg.mhc_finalize_gram_launch(
        residual,
        partials,
        scale,
        bias,
...
@torch.library.custom_op(
    "b12x_sqg::mhc_post_launch_functional",
    mutates_args=(),
)
...
def run_mhc_post_functional(
    *,
    ...
    return torch.ops.b12x_sqg.mhc_post_launch_functional(
        x,
        residual,
        prev_post,
        prev_comb,
...
@torch.library.custom_op(
    "b12x_sqg::mhc_pre_launch_functional",
    mutates_args=(),
)
...
def run_mhc_pre_functional(
    *,
    ...
    return torch.ops.b12x_sqg.mhc_pre_launch_functional(
        residual,
        fn,
        scale,
        bias,
...
@torch.library.custom_op(
    "b12x_sqg::mhc_post_pre_launch_functional",
    mutates_args=(),
)
...
def run_mhc_post_pre_functional(
    *,
    ...
    norm_weight_for_kernel = norm_weight if norm_weight is not None else residual
    return torch.ops.b12x_sqg.mhc_post_pre_launch_functional(
        x,
        residual,
        prev_post,
        prev_comb,
