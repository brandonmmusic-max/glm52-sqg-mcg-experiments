...
from b12x_sqg._lib.compiler import (
    KernelCompileSpec,
    compile as b12x_compile,
)
from b12x_sqg._lib.intrinsics import (
    align_up,
    as_grouped_scale_view,
)
from b12x_sqg._lib.utils import (
    current_cuda_stream,
...
from b12x_sqg.moe._shared.routing import (
    route_topk as triton_route_topk,
)
from b12x_sqg.moe._shared.kernels.relu2 import (
    MoEDynamicKernelRelu2,
    MoEMicroKernelRelu2,
)
from b12x_sqg.moe._shared.kernels.silu import (
    MoEDynamicKernelSilu,
    MoEDynamicKernelSwiGLUOAI,
    MoEMicroKernelSilu,
    MoEMicroKernelSwiGLUOAI,
)
from b12x_sqg.moe._shared.kernels.situ import (
    MoEDynamicKernelSitu,
    MoEMicroKernelSitu,
)
from b12x_sqg.moe._shared.kernels.activations import (
    SITU,
...
from b12x_sqg.moe._shared.tuning import lookup_max_active_clusters
from b12x_sqg._lib.runtime_control import (
    raise_if_kernel_resolution_frozen,
)
from b12x_sqg._lib.scratch import (
    ScratchBufferSpec,
    scratch_buffer_spec,
    scratch_tensor,
)
...
def _get_activation_kernel_spec(
    ...
    *,
    ...
    if _normalize_quant_mode(quant_mode) == "w4a16":
        raise ValueError(
            "W4A16 dispatch uses b12x_sqg.moe._shared.kernels.w4a16.kernel directly"
        )
    if (
...
def clear_tp_moe_caches() -> None:
    ...
    """
    from b12x_sqg.moe._shared.kernels.w4a16.kernel import (
...
def _arena_core_token_counts(
    *,
    ...
    if quant_mode == "w4a16" and bucket_w4a16_tokens:
        from b12x_sqg.moe._shared.kernels.w4a16.host import (
...
def _derive_w4a8_weight_grids(
    ...
    from b12x_sqg.moe._shared.kernels.reference import (
...
def _prepare_w6a8_from_mxfp6_source(
    *,
    ...
    scales.  Returns a
    :class:`b12x_sqg.moe._shared.kernels.w6a8.PreparedW6A8MXFP6Weights`.
    """
    from b12x_sqg.moe._shared.kernels.w6a8 import prepare_w6a8_mxfp6_weights
...
def prepare_b12x_fp4_moe_weights(
    *,
    ...
    if plan.source_format == "qsrt_sqg_e4m3":
        ...
        from b12x_sqg.moe._shared.kernels.w4a16.prepare import (
...
def prewarm_w4a16_fc2_e8m0(experts, *, route_ids_dtype: torch.dtype) -> None:
    ...
    from b12x_sqg.moe._shared.kernels.w4a16 import kernel as w4a16_kernel
    from b12x_sqg.moe._shared.kernels.w4a16.prepare import W4A16FC2Weights
...
def run_w4a16_fc2_e8m0(
    ...
    *,
    ...
    from b12x_sqg.moe._shared.kernels.w4a16 import kernel as _w4a16_kernel  # noqa: F401
    from b12x_sqg.moe._shared.kernels.w4a16.prepare import W4A16FC2Weights
    ...
    torch.ops.b12x_sqg.w4a16_fc2_direct_launch(
        intermediate,
        experts.w2,
        experts.w2_scale,
...
def _plan_full_rotation_w4a16_launches(
    *,
    ...
    from b12x_sqg.moe._shared.kernels.w4a16.host import route_pack_capacity
    from b12x_sqg.moe._shared.kernels.w4a16.kernel import (
...
def _resolve_trellis_route_block_size(caps: TPMoEScratchCaps) -> int | None:
    ...
    if caps.source_format not in _TRELLIS_SOURCE_FORMATS:
        return None
    from b12x_sqg.moe._shared.kernels.w4a16.host import select_route_block_size_m
...
@torch.library.custom_op(
    "b12x_sqg::tp_moe_dynamic_launch",
...
def _launch_dynamic(
    *,
    ...
    torch.ops.b12x_sqg.tp_moe_dynamic_launch(
...
def _launch_dynamic_topk_sum(
    *,
    ...
    torch.ops.b12x_sqg.w4a16_topk_sum_launch(
        route_output,
        output,
        m,
        num_topk,
...
def _get_tiny_decode_kernel(
    ...
    *,
    ...
    from b12x_sqg.moe._shared.kernels.tiny_decode import (
...
@torch.library.custom_op(
    "b12x_sqg::tp_moe_tiny_decode_launch",
    mutates_args="unknown",
)
...
@torch.library.custom_op(
    "b12x_sqg::tp_moe_compact_micro_launch",
    mutates_args="unknown",
)
...
def _launch_micro(
    *,
    ...
    if quant_mode == "w4a8_mx":
        ...
        torch.ops.b12x_sqg.tp_moe_tiny_decode_launch(
            workspace.barrier_count,
            workspace.barrier_epoch,
    ...
    if flat_ids.dtype == torch.int32 and flat_ids.is_contiguous():
        ...
        launch_ids = workspace.compact_topk_ids[: flat_ids.numel()]
        launch_ids.copy_(flat_ids.to(torch.int32))
    torch.ops.b12x_sqg.tp_moe_compact_micro_launch(
        workspace.barrier_count,
        workspace.barrier_epoch,
        workspace.micro_intermediate,
        weights.w1_storage,
