...
from b12x_sqg._lib.quant.sqg_e4m3 import sqg_xor_cheb_t12_lut
from b12x_sqg._lib.utils import current_cuda_stream, make_ptr
from b12x_sqg.moe._shared.kernels.w4a16.route_pack import (
...
@torch.library.custom_op(
    "b12x_sqg::w4a16_small_m_direct_launch",
...
@torch.library.custom_op(
    "b12x_sqg::w4a16_fc2_direct_launch",
    mutates_args="unknown",
)
...
@torch.library.custom_op(
    "b12x_sqg::w4a16_fused_moe_launch",
    mutates_args="unknown",
)
...
@torch.library.custom_op(
    "b12x_sqg::w4a16_fused_moe_calibrated_launch",
    mutates_args="unknown",
)
...
@torch.library.custom_op(
    "b12x_sqg::w4a16_topk_sum_launch",
    mutates_args=("output",),
)
    ...
    *,
    ...
    if (not collect_activation_amax) and _small_m_direct_supported(
        ...
        if _small_m_direct_host_barrier_reset_enabled():
            barrier_count.zero_()
            barrier_epoch.zero_()
        torch.ops.b12x_sqg.w4a16_small_m_direct_launch(
            a_input,
    ...
    if use_x4t_scale_predecode:
        ...
        from b12x_sqg._lib.quant.x4t_scales import (
    ...
    if collect_activation_amax:
        ...
        torch.ops.b12x_sqg.w4a16_fused_moe_calibrated_launch(
            *launch_common,
            activation_amax,
            int(layer_idx_int),
            *launch_tail,
        ...
        torch.ops.b12x_sqg.w4a16_fused_moe_launch(
            *launch_common,
            *launch_tail,
            bool(use_direct_topk_routes),
            bool(use_tc_decode),
