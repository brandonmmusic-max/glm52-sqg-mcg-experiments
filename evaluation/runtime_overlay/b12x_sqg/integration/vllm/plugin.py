"""Installable vLLM plugin that registers the b12x_sqg MX-FP6 (W6A6/W6A8) quantization.

Wire through vLLM's ``general_plugins`` entry point (see README)::

    [project.entry-points."vllm.general_plugins"]
    b12x_fp6 = "b12x_sqg.integration.vllm.plugin:register_b12x_fp6"
...
4. ``get_quant_method`` dispatches each layer to the kernels in
   :mod:`b12x_sqg.integration.vllm.fp6_serving`:
     * ``FusedMoE``  -> ``_VllmMoEMethod`` -> :class:`B12XFP6MoEMethod`
       -> ``b12x_sqg.moe.fused_moe`` (``w6a8_mx``)
     * ``LinearBase``-> ``_VllmLinearMethod`` -> ``b12x_sqg::fp6_dense_linear``
...
from b12x_sqg.integration.vllm.fp6_serving import (
    QUANT_ALGO,
    QUANT_METHOD,
    B12XFP6MoEMethod,
...
# b12x_sqg small-N GEMV.  See b12x_sqg.gemm.bf16_gemv for the thresholds.
from b12x_sqg.gemm.bf16_gemv import (  # noqa: E402
...
logger = logging.getLogger("b12x_sqg.vllm_fp6")
...
def register_b12x_fp6() -> None:
    ...
    class _VllmLinearMethod(LinearMethodBase):  # type: ignore[misc]
        ...
        def process_weights_after_loading(self, layer: Any) -> None:
            from b12x_sqg.quantization.mxfp6.fp6_checkpoint import (
                resolve_activation_format,
            )
            from b12x_sqg.quantization.mxfp6.fp6_dense_weights import PACKED_GEMM_MIN_N
            ...
            import b12x_sqg.quantization.mxfp6.fp6_dense_op  # noqa: F401
        ...
        def apply(
            ...
            y = torch.ops.b12x_sqg.fp6_dense_linear(
    ...
    class _VllmSmallNBF16Method(UnquantizedLinearMethod):  # type: ignore[misc]
        def process_weights_after_loading(self, layer: Any) -> None:
            ...
            import b12x_sqg.gemm.bf16_gemv  # noqa: F401
        ...
        def apply(
            ...
            if (
                ...
                y = torch.ops.b12x_sqg.bf16_gemv_small_n(x2d, w)
    ...
    class _VllmMoEMethod(FusedMoEMethodBase):  # type: ignore[misc]
        ...
        def process_weights_after_loading(self, layer: Any) -> None:
            from b12x_sqg.moe import fused_moe
    ...
    class B12XFp6Config(QuantizationConfig):  # type: ignore[misc]
        ...
        def _ensure_loaded(self) -> None:
            ...
            from b12x_sqg.quantization.mxfp6.fp6_checkpoint import WEIGHT_SCALE_SUFFIX
            from b12x_sqg.quantization.mxfp6.fp6_safetensors_load import (
                _source_format_from_config,
            )
            from b12x_sqg.quantization.mxfp6.model_fp6 import SafetensorsModel
            from b12x_sqg.quantization.mxfp6.fp6_checkpoint import (
...
def _dense_weight_from_loaded(
    ...
    *,
    ...
    from b12x_sqg._lib.intrinsics import swizzle_block_scale
    from b12x_sqg.quantization.mxfp6.fp6_checkpoint import (
        activation_format_for_source,
        weight_format_for_source,
    )
    from b12x_sqg.quantization.mxfp6.fp6_dense_weights import FP6DenseWeight
