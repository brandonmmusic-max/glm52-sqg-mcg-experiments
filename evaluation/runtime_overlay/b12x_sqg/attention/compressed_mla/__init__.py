...
Example:
    from b12x_sqg.attention import compressed_mla
...
META = OpMeta(
    ...
    provenance=Provenance(
        repo="https://github.com/lukealonso/b12x_sqg",
        commit="6627d342",
        paths=(
            "b12x_sqg/attention/mla/compressed_api.py",
            "b12x_sqg/integration/compressed_scratch.py",
        ),
    ),
