...
``b12x_sqg/attention/indexer/kernel.py`` (``_compute_mxfp8_tile_partials`` et al.)
and the radix select / virtual-index loaders from
``b12x_sqg/attention/indexer/tiled_topk.py``; nothing is reinvented here.
"""
...
from b12x_sqg._lib.intrinsics import shared_ptr_to_u32
...
from b12x_sqg.attention.nsa_indexer.persistent_topk import (
    _RADIX,
    _RADIX_THRESHOLD,
...
from b12x_sqg.attention.nsa_indexer.tiled_topk import (
    _SCAN_UNROLL,
    _SMEM_CANDS,
    _SUPPORTED_TOPK,
...
from b12x_sqg._lib.intrinsics import ld_shared_f32
