...
from b12x_sqg.attention._shared.cute.ops import LOG2_E
...
from b12x_sqg._lib.compiler import launch as b12x_launch
...
def _cache_block_stride_bytes(
    ...
    *,
    ...
    from b12x_sqg.attention._shared.mla.compressed_reference import (
...
@torch.library.custom_op(
    "b12x_sqg::sparse_mla_sm120_prefill_mg",
...
@torch.library.custom_op(
    "b12x_sqg::sparse_mla_sm120_prefill_mg_dual",
    mutates_args=("output", "lse_out"),
)
    ...
    *,
    ...
    if has_extra:
        ...
        if full_head_tile and active_heads == total_heads and head_offset == 0:
            torch.ops.b12x_sqg.sparse_mla_sm120_prefill_mg_dual(
                q,
    ...
    if full_head_tile and active_heads == total_heads and head_offset == 0:
        torch.ops.b12x_sqg.sparse_mla_sm120_prefill_mg(
            q,
            _cache_base_tensor(kv_cache),
            topk_indices,
            topk_length,
