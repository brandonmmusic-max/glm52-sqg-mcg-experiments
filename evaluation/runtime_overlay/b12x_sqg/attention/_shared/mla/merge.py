...
from b12x_sqg.attention._shared.workspace import _SPLIT_MAX_CHUNKS
...
@torch.library.custom_op(
    "b12x_sqg::sparse_mla_sm120_split_decode_merge",
    mutates_args=("output",),
)
...
def run_sparse_mla_split_decode_merge(
    *,
    ...
    torch.ops.b12x_sqg.sparse_mla_sm120_split_decode_merge(
        tmp_output,
        tmp_lse,
        num_chunks_ptr,
        output,
