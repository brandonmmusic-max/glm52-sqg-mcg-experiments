...
from b12x_sqg.attention._shared.contiguous.forward import (
...
def _select_tile_shape(head_dim: int, *, causal: bool) -> tuple[int, int]:
    ...
    raise ValueError(
        f"unsupported head_dim={head_dim} for the current b12x_sqg attention path"
    )
    ...
    def __init__(
        ...
        *,
        ...
        if not ContiguousAttentionForwardKernel.can_implement(
            ...
            raise TypeError(
                "b12x_sqg attention launch is unsupported with "
    ...
    def __init__(
        ...
        *,
        ...
        if not ContiguousAttentionForwardKernel.can_implement(
            ...
            raise TypeError(
                "b12x_sqg varlen attention launch is unsupported with "
                f"dtype={dtype}, q_shape={q_shape}, k_shape={k_shape}, v_shape={v_shape}, "
...
def clear_attention_caches() -> None:
    """Clear global compile caches owned by the b12x_sqg attention integration."""
