...
before it was removed by `2a6d711c` (`2a6d711c^:b12x_sqg/attention` plus the
matching `2a6d711c^:b12x_sqg/integration/attention.py` entrypoints).

Internal imports are redirected under `b12x_sqg.attention.contiguous`.
