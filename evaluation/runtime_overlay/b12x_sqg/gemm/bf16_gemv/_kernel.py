...
This module also registers ``b12x_sqg::bf16_gemv_small_n`` so a Dynamo /
...
from b12x_sqg._lib.compiler import KernelCompileSpec
from b12x_sqg._lib.compiler import compile as b12x_compile
...
def precompile_bf16_gemv_small_n(weight: torch.Tensor, log=None) -> None:
    ...
    if log is None:
        ...
        log = logging.getLogger("b12x_sqg.bf16_gemv")
...
@torch.library.custom_op("b12x_sqg::bf16_gemv_small_n", mutates_args=())
