...
through an opaque torch custom op (``b12x_sqg::bf16_gemv_small_n``), so it
...
Example:
    from b12x_sqg.gemm import bf16_gemv
...
META = OpMeta(
    ...
    provenance=Provenance(
        repo="https://github.com/phaelon74/b12x_sqg",
        commit="9c78d553",
        paths=(
            "b12x_sqg/gemm/bf16_gemv.py",
            "b12x_sqg/gemm/bf16_gemv_op.py",
            "b12x_sqg/integration/vllm_plugin.py",
        ),
    ),
