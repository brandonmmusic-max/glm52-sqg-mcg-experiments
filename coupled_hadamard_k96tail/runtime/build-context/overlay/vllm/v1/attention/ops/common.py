...
def mask_dcp_empty_shards_(
    ...
    # With zero sequences (e.g. a pure-prefill batch reaching a decode-side
    # merge during the profile pass) every row is padding; indexing an empty
    # seq_lens would raise, and the boundary mask above already covers it.
    if seq_lens.shape[0] > 0:
        ...
        empty_rows = empty_rows | (seq_lens[sequence_indices] == 0)
