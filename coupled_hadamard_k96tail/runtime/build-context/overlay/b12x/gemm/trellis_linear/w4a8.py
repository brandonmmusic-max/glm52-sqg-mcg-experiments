...
class _TrellisW4A8DenseLaunch:
    ...
    groups.  This removes the prior linear growth in trellis decode work with
    M while keeping the exact same compact weight bytes and FP8 MMA math.
    """
    ...
    def _tile_base(
        ...
        if cutlass.const_expr(self.pair_kind is None):
            ...
            return (
                Int64(k16) * Int64(n16_count) + Int64(n16)
            ) * Int64(8 * int(bits))
